...
namespace csharp_exception.Contas
{
    public class ContaCorrente
    {
        ...
        public bool Sacar(double valor)
        {
            ...
            {
                throw new SaldoInsuficienteException("Saldo insucifiente para ação.");
            }
        }
        ...
        public bool Transferir(double valor, ContaCorrente destino)
        {
            if (saldo < valor)
            {
                throw new SaldoInsuficienteException("Transferencia não-autorizada por saldo insufiente.");
            }
            else
            {
                Sacar(valor);
        ...
        public ContaCorrente(int numero_agencia, string numero_conta, Cliente titular)
        {
